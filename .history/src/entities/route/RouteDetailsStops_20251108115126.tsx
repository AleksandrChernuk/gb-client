    ...
    <div className="space-y-2">
      ...
      {showToggleButton && (
        <Button
          ...
          variant="outline"
          className="flex items-center self-end gap-px p-2 text-green-300 underline cursor-pointer text-[12px] font-bold tracking-normal leading-[18px] text-nowrap w-fit"
        >
