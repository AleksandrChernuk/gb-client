...
import { ClearInputButton } from './helpers/ClearInputButton';
import {
  Sheet,
  SheetClose,
  SheetContent,
          ...
          <div className="sticky top-0 left-0 right-0 h-12 bg-slate-50 dark:bg-slate-900 z-50">
            <div className="relative py-4 bg-slate-50 dark:bg-slate-900">
              <input
                ...
                autoCapitalize="off"
                spellCheck="false"
                className="text-[16px] text-slate-700 dark:text-slate-50 placeholder:text-slate-300 dark:placeholder:text-slate-600 p-4 pr-10 h-full w-full bg-white dark:bg-slate-800 rounded-lg border-[1px] border-slate-700 focus:border-green-300 outline-green-300 placeholder:italic"
              />
