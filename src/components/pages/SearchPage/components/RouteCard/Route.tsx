    ...
    <>
      <div className="flex flex-row items-center gap-2 tablet:hidden">
        ...
        <div className="space-y-2">
          <LocationDisplay
            location={extractLocationDetails(route.departure.fromLocation, currentLocale).locationName}
            address={route.departure.station_address || ""}
            variant="mobile"
          />

          <LocationDisplay
            location={extractLocationDetails(route.arrival.toLocation, currentLocale).locationName}
