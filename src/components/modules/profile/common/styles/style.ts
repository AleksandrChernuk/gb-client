export const S = {
  ...
  label: 'truncate text-xs tracking-wide text-green-300',
  ...
  detailsBtn:
    'flex items-center self-end gap-px p-2 text-green-300 dark:text-green-300 underline cursor-pointer text-[12px] font-bold tracking-normal leading-[18px] text-nowrap transition-all duration-200',
