  ...
  return (
    <div
      className={`relative flex items-start justify-start ${
        isLast && 'overflow-hidden z-10 bg-grayy tablet:bg-white dark:bg-dark_bg'
      }`}
    >
      <div
        className={`${
      ...
      <div
        className={`details_stops_item ${
          isLast ? 'before:border-primary_1' : 'before:border-blackmode before:bg-grayy dark:before:bg-dark_bg'
        } `}
      >
        {isLast && (
