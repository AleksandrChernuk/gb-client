...
export const MobileMenu = ({ isAuthHeader }: { isAuthHeader?: boolean }) => {
  ...
  return (
    <div className="block tablet:hidden">
      ...
      >
        <div className="sticky top-0 z-50 px-5 py-4  bg-white dark:bg-dark_main border-b-[1px] border-gray_0 dark:border-black_2_for_text flex items-center justify-between">
          <DrawerClose>
            <Logo />
          </DrawerClose>
          <DrawerClose asChild>
