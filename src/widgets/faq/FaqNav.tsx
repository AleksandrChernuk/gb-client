  ...
  return (
    <div className="flex items-start gap-2 overflow-x-scroll tablet:overflow-hidden tablet:gap-0 tablet:flex-col no-scrollbar animate-all">
      ...
      <Button
        ...
        asChild
        variant="link"
        className={`p-2 text-sm font-normal tracking-normal leading-[21px] tablet:p-4 tablet:text-sm tablet:font-normal tablet:leading-4 tablet:tracking-normal laptop:text-lg laptop:leading-[27px] text-slate-700 dark:text-slate-50 rounded-none  tablet:dark:border-b-slate-700 tablet:border-b-0 tablet:border-l-2  tablet:border-l-[#e6e6e6] tablet:dark:border-l-slate-700   ${slug === '/faq/ticket-refund' && ' text-green-200 dark:text-green-100  tablet:border-l-green-300 tablet:dark:border-l-green-100 break-words'}`}
      >
